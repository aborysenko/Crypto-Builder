...
namespace CryptoBuilder.Crypto.Digests
{
    ...
    /// sizes, based on the <see cref="CryptoBuilder.Crypto.Engines.ThreefishEngine">Threefish</see> tweakable block cipher.
    /// </summary>
    /// <remarks>
    ...
    /// <p/>
    /// This implementation is the basis for <see cref="CryptoBuilder.Crypto.Digests.SkeinDigest"/> and <see cref="CryptoBuilder.Crypto.Macs.SkeinMac"/>, implementing the
    /// parameter based configuration system that allows Skein to be adapted to multiple applications. <br/>
    /// Initialising the engine with <see cref="CryptoBuilder.Crypto.Parameters.SkeinParameters"/> allows standard and arbitrary parameters to
    ...
    /// </ul>
    /// </remarks>
    /// <seealso cref="CryptoBuilder.Crypto.Parameters.SkeinParameters"/>
        ...
        : IMemoable
    {
        ...
        /// <summary>
        /// Initialises the Skein engine with the provided parameters. See <see cref="CryptoBuilder.Crypto.Parameters.SkeinParameters"/> for
