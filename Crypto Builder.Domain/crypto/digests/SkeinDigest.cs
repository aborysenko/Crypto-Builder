...
namespace CryptoBuilder.Crypto.Digests
{
	...
	/// based on the <see cref="CryptoBuilder.Crypto.Engines.ThreefishEngine">Threefish</see> tweakable block cipher.
	/// </summary>
	/// <remarks>
	...
	/// </remarks>
	/// <seealso cref="CryptoBuilder.Crypto.Digests.SkeinEngine"/>
		...
		: IDigest, IMemoable
	{
        ...
        public SkeinDigest()
        {
            this.engine = new SkeinEngine(SKEIN_512, SKEIN_512);
		...
		/// </summary>
		/// See <see cref="CryptoBuilder.Crypto.Parameters.SkeinParameters"></see> for details on the parameterisation of the Skein hash function.
