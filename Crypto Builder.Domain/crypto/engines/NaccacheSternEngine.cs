...
namespace CryptoBuilder.Crypto.Engines
{
	/**
	...
	*/
		...
		: IAsymmetricBlockCipher
	{
		...
		*
		* @see CryptoBuilder.crypto.AsymmetricBlockCipher#init(bool,
		*      CryptoBuilder.crypto.CipherParameters)
		*/
...
//						accJ = priv.PhiN.Multiply(bigJ);
		...
		*
		* @see CryptoBuilder.crypto.AsymmetricBlockCipher#GetInputBlockSize()
		*/
...
//				return key.Modulus.ToByteArray().Length;
		...
		*
		* @see CryptoBuilder.crypto.AsymmetricBlockCipher#GetOutputBlockSize()
		*/
...
//				return key.Modulus.ToByteArray().Length;
		...
		*
		* @see CryptoBuilder.crypto.AsymmetricBlockCipher#ProcessBlock(byte[],
		*      int, int)
		*/
