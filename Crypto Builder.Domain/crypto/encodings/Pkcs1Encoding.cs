...
namespace CryptoBuilder.Crypto.Encodings
{
    /**
    ...
    */
        ...
        : IAsymmetricBlockCipher
    {
         ...
         * work with one of these set the system property CryptoBuilder.Pkcs1.Strict to false.
         */
        public const string StrictLengthEnabledProperty = "CryptoBuilder.Pkcs1.Strict";
