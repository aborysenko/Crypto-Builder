...
namespace CryptoBuilder.Crypto.Agreement.JPake
{
    /// <summary>
    ...
    public class JPakeRound3Payload
    {
        ...
        /// 
        /// See JPAKEUtil#calculateMacTag(string, string, BigInteger, BigInteger, BigInteger, BigInteger, BigInteger, CryptoBuilder.crypto.Digest)
        /// </summary>
