...
namespace CryptoBuilder.Crypto.Macs
{
        ...
        : IMac
    {
        ...
        /// <summary>
        /// Initialises the GMAC - requires a <see cref="CryptoBuilder.Crypto.Parameters.ParametersWithIV"/> 
        /// providing a <see cref="CryptoBuilder.Crypto.Parameters.KeyParameter"/> and a nonce.
        /// </summary>
