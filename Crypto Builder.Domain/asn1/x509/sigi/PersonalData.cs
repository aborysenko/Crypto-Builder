...
using CryptoBuilder.Asn1.X500;
using CryptoBuilder.Math;
using CryptoBuilder.Utilities;

namespace CryptoBuilder.Asn1.X509.SigI
{
	/**
	...
	* </pre>
	*
	* @see CryptoBuilder.asn1.x509.sigi.NameOrPseudonym
	* @see CryptoBuilder.asn1.x509.sigi.SigIObjectIdentifiers
	*/
