namespace CryptoBuilder.Asn1.IsisMtt
{
	public abstract class IsisMttObjectIdentifiers
	{
		 ...
		 * </pre>
		 * 
		 * @see CryptoBuilder.Asn1.IsisMtt.X509.Restriction
		 */
		 ...
		 * 
		 * @see CryptoBuilder.Asn1.IsisMtt.Ocsp.RequestedCertificate
		 */
		 ...
		 *
		 * @see CryptoBuilder.Asn1.IsisMtt.Ocsp.CertHash
		 */
		 ...
		 * 
		 * Used in
		 * {@link CryptoBuilder.Asn1.X509.SubjectDirectoryAttributes SubjectDirectoryAttributes}
		 */
		 ...
		 * </pre>
		 * 
		 * @see CryptoBuilder.Asn1.IsisMtt.X509.AdditionalInformationSyntax
		 */
